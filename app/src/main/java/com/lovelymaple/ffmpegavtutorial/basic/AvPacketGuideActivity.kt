...
import com.lovelymaple.ffmpegavtutorial.databinding.ActivityAvPacketGuideBinding
...
class AvPacketGuideActivity : AppCompatActivity() {

    private lateinit var binding: ActivityAvPacketGuideBinding
    private lateinit var nativeInstance: NativeInstance

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityAvPacketGuideBinding.inflate(layoutInflater)
    ...
    private fun runNativeDemo() {
        binding.statusText.text = getString(R.string.av_packet_status_loading)
        binding.refreshButton.isEnabled = false
        try {
            nativeInstance.runAvPacketDemo()
            binding.statusText.text = getString(R.string.av_packet_status_ready)
        } catch (t: Throwable) {
            binding.statusText.text = getString(
                R.string.av_packet_status_error,
